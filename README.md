...
The stuff under this message does not fully apply.
This is a WIP, the original image didnt contain what I need so this is my
modifications so I can build for more archs

I use the buildContainer script to make the containers then tag them with whatever arch they have 
